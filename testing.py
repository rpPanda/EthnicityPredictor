...
def predict(X_img_path, knn_clf=None, model_path=None, distance_threshold=0.66):
    """
...
def show_prediction_labels_on_image(img_path, predictions):
    ...
    for name, (top, right, bottom, left) in predictions:
        ...
        draw.rectangle(((left, bottom - text_height - 10), (right, bottom)), fill=(255, 0, 255), outline=(255, 0, 255))
